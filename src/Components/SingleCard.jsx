...
const SingleCard = ({ title, original_title, original_language, vote_average, poster_path, overwiev}) => {
    ...
    return (
        <>
            <div className="cardContainer">
                <img src={`http://image.tmdb.org/t/p/w342/${poster_path}`} className='cover' />
                <div className="infoContainer">
                    ...
                    <h3 className='stars'>{stars(numRounder(vote_average))}</h3> 
                    <p>{overwiev}</p>
                </div>
            </div>
        </>
